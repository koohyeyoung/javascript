...
- Object(객체), Array(배열), function(함수)등 다양한 객체가 존재한다.
...
/*
불린(boolean)
- true 와 false 두 가지 값만 가지는 논리형 데이터 타입이다.
*/ 
...
/*
심볼(Symbol)
- 유일한 값을 나타내기 위해 ES6 버전에서 도입한 데이터 타입이다.
- 고유한 식별자가 필요할 때 사용한다.
*/ 
...
console.log(key1 == key2); //symbol 같은 서로 다르다 

console.log(key1);
console.log(key1.description); //symbol의 값 표현
