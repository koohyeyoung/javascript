...
name = "구혜영"; //name 변수의 값을 구혜영으로 변경
console.log(name);

// let name = "구혜영" //같은 영역안에 추가 생성 불가


/*
상수
- 변수와 마찬가지로 값을 담지만 할당된 값을 바꿀 수 없다.
- 상수를 선언할 때는 const 라는 키워드를 사용한다.
*/ 
...
- 카멜 케이스 
  - 중간 단어의 첫 글자가 대문자이며, 낙타의 혹처럼 보인다고 해서 카멜 케이스 라고 불린다.
    ex) camelCaseNum
...
- 케밥 케이스
  - 케밥이 꼬챙이에 꽃힌 모습처럼 보인다고 해서 케밥 케이스라고 한다.
    ex) kebab-case //js 에선 사용할 수 없음
...
console.log(temp2); // 스코프의 영향을 받지 않음
